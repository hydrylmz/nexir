...
pub fn swr_output_sample_count(input_samples: usize, in_rate: u32, out_rate: u32) -> usize {
    // Math: ceil(in_count * out_rate / in_rate) + SWR_DELAY_MARGIN
    // Delay margin = 16 (for polyphase filter internal delay)
    ((input_samples as i64 * out_rate as i64 + in_rate as i64 - 1) / in_rate as i64 + 16) as usize
}
